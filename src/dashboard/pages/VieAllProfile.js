import VieAllProfileform from '../components/VieAllProfileform'
    ...
    <div className="dashboard">
      ...
      <div className="dashboard-content">
        ...
        <div style={{ marginTop: '100px', marginLeft }}>
          ...
          <VieAllProfileform userId={id} /> {/* Passing userId prop */}
        </div>
      </div>
    </div>
  );
